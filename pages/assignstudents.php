...
// Must pass login
$PAGE->set_url('/blocks/edureportbook/pages/assignstudents.php?id=' . $id);
require_login($course->id);
$PAGE->set_context($context);
$PAGE->set_title(get_string('assignstudents', 'block_edureportbook'));
$PAGE->set_heading(get_string('assignstudents', 'block_edureportbook'));
